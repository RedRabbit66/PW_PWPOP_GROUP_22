...
-- INSERT INTO products(hash_id, user_id, description, datetime, price, category, file_name, file_path) VALUES('hash2', 1, "llure2 desc", NOW(), 200, 1, 'llorenc2', 'llure2.jpg');
 ...
 -- INSERT INTO products(hash_id, user_id, description, dateUpload, price, category, title, product_image) VALUES('hash75', 1, "llure3 desc", NOW(), 200, 1, 'llorefffnc3','llure.jpg');
 -- INSERT INTO products(hash_id, user_id, description, dateUpload, price, category, title, product_image) VALUES('hash4', 1, "llure4 desc", NOW(), 200, 1, 'llorenc4','llure2.jpg');
 -- INSERT INTO products(hash_id, user_id, description, dateUpload, price, category, title, product_image) VALUES('hash5', 1, "llure5 desc", NOW(), 200, 1, 'llorenc5','llure2.jpg');
 -- INSERT INTO products(hash_id, user_id, description, dateUpload, price, category, title, product_image) VALUES('hash6', 1, "llure6 desc", NOW(), 200, 1, 'llorenc6','llure2.jpg');
